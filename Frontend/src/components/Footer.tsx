...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-12 pt-6 border-t border-slate-200/60 dark:border-slate-800/80 pb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-slate-400 dark:text-slate-500 font-medium transition-colors">
